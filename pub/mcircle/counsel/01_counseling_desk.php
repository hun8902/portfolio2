...
<body class="agent">
	...
	<article>
		...
		<script>
			function detail_mdf(){
				$("#detail_md").addClass("on");
				$("#detail_md").draggable({handle: ".popup_header p"}, {containment: "article"});
			}
			$(function(){ 
				
				$("#detail_md_close").click(function(){
					$("#detail_md").removeClass("on");
				});
				$("#detail_md_close_foot").click(function(){
					$("#detail_md").removeClass("on");
				});
			});
		</script>
		<section id="detail_md" class="w568">
			<div class="popup_header">
				<p>수정하기</p>
				<div id="detail_md_close" class="popup_close"><i class="material_icons">close</i></div>
			...
			<div class="popup_content">
				<div class="form_content">
					...
					<div class="obj_label w20">
						<label for="clienAsking">처리내용<p>2018-05-30<br/>11:30:24<p></label>
					</div>
					<div class="obj w80">
						<textarea name="clienAsking" id="clienAsking" class="h95 resize_none" maxlength="400" wrap="hard"></textarea>
					</div>
				...
				<div class="mw100">
				<button class="blue" name="" id="detail_md_close_foot" >수정</button>
				</div>
			</div>
		...
		<script>
			$(function(){ 
				...
				$("#notice_popup_close_foot").click(function(){
					$("#notice_popup").removeClass("on");
				});
			});
		</script>
		<section id="notice_popup" class="w1307">
			<div class="popup_header">
				<p>공지사항</p>
				<div id="notice_popup_close" class="popup_close"><i class="material_icons">close</i></div>
			</div><!-- popup_header end -->
			...
			<div class="popup_content">
						...
						<table id="" class="tablesorter">
							...
							<tbody>
								<tr>
									...
									<td>홍길동</td>
									<td>00</td>
									<td class="line_select">일이삼사오육칠팔구십</td>
									<td>홍길동</td>
								</tr>
								<tr>
									<td >2018-00-00</td>
				...
				<div class="section_wrap_r40">
					<!-- 공지내용 -->
					<section id="" class="">
						<header>
							<p class="title"><i class="material_icons px_24">notification_important</i>공지</p>
						</header>
						<div class="form_content h340">
							<!-- 거래처명 -->
							<div class="obj_label w25 padding_none">
								<label for="clientName">공지(작성)일자</label>
							</div>
							<div class="obj w25">
								<input type="text" name="" id="clientName" value="">
							</div>
							 ...
							 <!-- 대표자명 -->
							<div class="obj_label w25 padding_none">
								<label for="clientName">공지대상</label>
							</div>
							<div class="obj w25">
							...
							<div class="obj w25">
							 ...
							 <!-- 이메일 -->
							<div class="obj_label w25 padding_none">
								<label for="clientName">활성화</label>
							</div>
							<div class="obj w25">
								<select id="infotype" name="infotype">
									<option value="1" selected>전체</option>
							...
							<div class="obj_label w20 padding_none">
								<label for="clientAddress">제 목</label>
							</div>
							<div class="obj w80">
							  ...
							  <!-- 내용 -->
							<div class="obj_label w20 padding_none">
								<label for="clientAddress">내 용</label>
							</div>
							<div class="obj w80">
								<textarea name="" id="" class="h180 resize_none" maxlength="400" wrap="hard"></textarea>
							</div>
			...
			<div class="popup_footer ">
				<div class="mw100">
				<button class="blue" name="" id="notice_popup_close_foot" >닫기</button>
				</div>
			</div>
		</section><!-- clientMoreInfo-view end -->
...
<section id="widget-101" class="">
    ...
    <footer>
		<button class="cyon" type="button" name="" id="saveClientInfo">메모</button>
		<!-- <button class="right" name="" id="openClientMoreInfo">임시</button>  -->
	...
	<section id="clientMoreInfo-view" class="">
		...
		<div class="popup_content">
			<div class="form_content">
				...
				<!-- <div class="clear" style="height: 600px;">높이 범위 초과시 스크롤바 상태 확인을 위한 공백</div> -->
			</div><!-- form_content end -->
		</div><!-- popup_content end -->
...
<section id="widget-102">
	<header>
		<p class="title"><i class="material_icons px_24">launch</i>상담 노트</p>
	...
	<div class="form_content">
		...
		<div class="obj_label w20">
			<label for="clienAsking">VOC</label>
		</div>
		<div class="obj w80">
			<textarea name="clienAsking" id="clienAsking" class="h95 resize_none" maxlength="400" wrap="hard"></textarea>
		</div>
	...
	<footer>
		<button class="blue " type="button" name="" onclick="counsel_save();">노트 저장</button>
		<button class="" type="button" name="" onclick="readyAfterSave();">저장 후 상담대기</button>
	</footer>
			...
			<div id="rtab_1">
				<div class="righttab_content">
					...
					<div class="w80">
						<!-- 수신자 번호 -->
						<div class="obj w100">
							<input type="text" name="" id="Vdepth1" value="">
						</div>
					</div>
					<div class="obj_label w20">
						<label>발신자 번호</label>
					...
					<div class="obj w100">
						<textarea name="" id="" class="h590 resize_none" maxlength="400" wrap="hard" ></textarea>
					</div>
					<footer>
						<button class="" type="button" name="" id="">초기화</button>
						<button class="blue" type="button" name="" onclick="">전송</button>
					</footer>
				</div>
			</div>
			<div id="rtab_2">
				...
				<div class="time_box">
					<div class="rtab2_time">
						<div class="time_text">시</div>
						<ul>
							<li id="hour_1">08</li>
							<li id="hour_2">09</li>
							<li id="hour_3">10</li>
					...
					<div class="rtab2_time">
						...
						<ul>
							<li id="minute_1">00</li>
							<li id="minute_2">10</li>
							<li id="minute_3">20</li>
							<li id="minute_4">30</li>
							<li id="minute_5">40</li>
							<li id="minute_6">50</li>
						</ul>
					</div>
					<div style="clear:both"></div>
				</div>
				<script>
				$(function() {
					$(".rtab2_time ul li").on("click",function() {
						var strArray = this.id.split('_');
						if(strArray[0]=="hour"){
							$('#time1').prop('selectedIndex', strArray[1]).selectric('refresh');
						}else{
							$('#time2').prop('selectedIndex', strArray[1]).selectric('refresh');
						}
				...
				<div class="rtab2_box">
					<div class="obj_label w20 padding_none">
						<label for="clientCode">예약시간</label>
					</div>
					<div class="obj w30">
					...
					<div class="obj w20">
						<select id="time1" name="time1" multiple>
				...
				<div class="rtab2_box">
					<div class="obj_label w20 padding_none">
						<label for="clientCode">예약번호</label>
					</div>
					<div class="obj w30">
				...
				<footer>
					<button class="blue" type="button" name="" onclick="">저장</button>
				</footer><!-- tab 2 끝 -->
			</div>
		...
		<section id="tabs" class="clear section_wrap_w1100">
			...
			<div id="tab_0">
				<div class="section_wrap_l50 p_r8">
					...
					<div class="tab_bottom">
						<button class=" " type="button" name="" >신규</button>
						<button class="blue " type="button" name="" onclick="counsel_save();">수정</button>						
					</div>
				</div>
			...
			<div id="tab_1"><!-- 상담이력 부분시작 -->
				...
				<div class="section_wrap_l50">
					...
					<div class="tab_bottom">
						<button class="right blue " type="button" name="" onclick="detail_mdf();">수정</button>
					</div>
