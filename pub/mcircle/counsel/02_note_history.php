	...
	<article>
		...
		<section class="query">
			<form name="cdrInquiry" id="cdrInquiry" action="">
				...
				<div class="obj w8">
					<!-- 통화 유형 선택 -->
					<label class="label_top">C. 통화 유형</label>
					<select id="" name="">
				...
				<div class="obj w8">
					<!-- 상담 결과 선택 -->
					<label class="label_top">D. 상담 결과</label>
					<select id="" name="">
						<option value="0" selected>전체</option>
						<option value="1">Define data 1</option>
						<option value="2">Define data 2</option>
				...
				<div class="obj w10">
					<!-- 상담 유형 선택 -->
					<label class="label_top">E. 상담 유형</label>
					<select id="" name="">
						<option value="0" selected>전체</option>
						<option value="1">Define data 1</option>
						<option value="2">Define data 2</option>
				...
				<div class="obj w8">
					<!-- 내선 선택 -->
					<label class="label_top">F. 내선</label>
					<select id="" name="">
						<option value="0" selected>전체</option>
						<option value="1">Define data 1</option>
						<option value="2">Define data 2</option>
			...
			<section>
				...
				<div class="form_content">
					...
					<div class="w80">
						<!-- 상담유형 대분류 -->
						<div class="obj w33">
							<input type="text" name="" id="" readonly="true" value="대분류 정보">
						</div>
						<!-- 상담유형 중분류 -->
						<div class="obj w33">
							<input type="text" name="" id="" readonly="true" value="중분류 정보">
						</div>
						<!-- 상담유형 소분류 -->
						<div class="obj w33">
							<input type="text" name="" id="" readonly="true" value="소분류 정보">
						</div>
					</div>
					...
					<div class="obj w80">
						<textarea name="agentAnswer-501" id="agentAnswer-501" class="h100 resize_none" maxlength="400" wrap="hard" readonly="true">꽃이 살았으며, 그들은 생명을 설레는 하여도 끝에 풀이 있다. 내려온 피고 붙잡아 얼음 약동하다. 것은 천하를 바이며, 이상이 기관과 사막이다. 이것을 이것이야말로 위하여, 트고, 인간은 대고, 봄바람이다.
...
봄바람을 인생에 사는가 있다. 위하여 그것은 풀밭에 같이, 시들어 힘차게 곳으로 것이다.</textarea>
					...
					<div class="obj w80">
						<input type="text" name="" id="" readonly="true" value="완료">
					</div>
