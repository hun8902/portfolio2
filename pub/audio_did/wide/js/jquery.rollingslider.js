          ...
          if (i == 0) {
            ...
            item_arr[i].css("z-index", prevStyleObj.zIndex).animate({
              ...
              height: prevStyleObj.height
				...
				$(css_text10).css("fontSize", "23px");
				$(css_text11).css("fontSize", "23px");
				$(css_text12).css("fontSize", "25px");
				$(css_text10).css("line-height", "55px");
				$(css_text11).css("line-height", "55px");
				$(css_text12).css("line-height", "66px");

				$(css_text1).css("fontSize", "20px");
				$(css_text2).css("fontSize", "20px");
				$(css_text3).css("fontSize", "22px");
				$(css_text1).css("padding-top","26px");
				$(css_text2).css("padding-top","26px");
				$(css_text3).css("padding-top","47px");


				$(css_text4).css("padding-top","10px");
				$(css_text5).css("padding-top","10px");
				$(css_text6).css("padding-top","15px");
				$(css_text4).css("padding-bottom","10px");
				$(css_text5).css("padding-bottom","10px");
				$(css_text6).css("padding-bottom","10px");
				
				$(css_text4).css("fontSize", "13px");
				$(css_text5).css("fontSize", "13px");					
				$(css_text6).css("fontSize", "15px");

				$(css_text7).css("fontSize", "13px");
				$(css_text8).css("fontSize", "13px");					
				$(css_text9).css("fontSize", "15px");
				$(css_text7).css("padding","25px 17px");
				$(css_text8).css("padding","25px 17px");
				$(css_text9).css("padding","30px 25px;");
