...
$result = mysql_query("SELECT * FROM bbs ORDER BY `bbs`.`seq` DESC");
...
<head>
    ...
    <script src="js/accordion_m.js"></script>
		...
		<div class="content">
			...
			<div class="wrapper">
				<div id="st-accordion" class="st-accordion">
						<style>
							.pagination{width:640px; _margin:0 0 40px 450px; clear:both; height:20px;}
						...
						<ul id="itemContainer1">
							<?php
								...
								for ($i = $start; $i < $end; $i++) {
									...
									echo '<a href="#"><div class="news_1"><img src="./img/' . mysql_result($result, $i, 'title') . '"></div>';
