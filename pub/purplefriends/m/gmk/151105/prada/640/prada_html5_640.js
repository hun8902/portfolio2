...
(lib.정 = function() {
	this.spriteSheet = ss["prada_html5_640_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.prada_html5_640 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// p3
	this.instance = new lib.p3_1();
	this.instance.setTransform(682,50,1,1,0,0,0,132,46);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({x:292},9,cjs.Ease.get(1)).wait(116).to({y:208},5,cjs.Ease.get(-1)).wait(5));

	// p2
	this.instance_1 = new lib.p2_1();
	this.instance_1.setTransform(761,49.5,1,1,0,0,0,137,46.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({x:371},9,cjs.Ease.get(1)).wait(116).to({y:-100.5},5,cjs.Ease.get(-1)).wait(3));

	// p1
	this.instance_2 = new lib.p1_1();
	this.instance_2.setTransform(829,50,1,1,0,0,0,137,46);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(8).to({_off:false},0).to({x:439},9,cjs.Ease.get(1)).wait(116).to({y:210},5,cjs.Ease.get(-1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({_off:false},0).to({x:161,alpha:1},4,cjs.Ease.get(1)).wait(118).to({y:39.5},4,cjs.Ease.get(-1)).to({y:-63.5},3).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).to({x:117,alpha:1},4,cjs.Ease.get(1)).wait(119).to({y:39.5},4,cjs.Ease.get(-1)).to({y:-63.5},3).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({_off:false},0).to({x:70,alpha:1},4,cjs.Ease.get(1)).wait(120).to({y:39.5},4,cjs.Ease.get(-1)).to({y:-63.5},3).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(8).to({_off:false},0).to({x:85.5,alpha:1},5,cjs.Ease.get(1)).to({x:90.5},4,cjs.Ease.get(1)).wait(111).to({y:66.5},4,cjs.Ease.get(-1)).to({y:189.5},4).wait(3));
