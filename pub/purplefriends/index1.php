...
$result = mysql_query("SELECT * FROM test_db2 ORDER BY `test_db2`.`news_no` DESC ");
...
<head>
    ...
    <script src="js/jquery.body.scroll.js"></script>
				...
				<div class="content">
					 <div id="slider">
						<div class="light" style="background-image: url(img/1.png);">
							<q class="main_banner_p"><a href="#" target="_blank"><img src="img/more.png"></a></q>
						</div>
					...
					<div class="s1_news">
						...
						<div class="s1_news_text">
							<ul>
								<li><a href="http://blog.buzzvil.com/2014/08/05/korean-mobile-advertising-lumascape-buzzscape/?utm_source=hootsuite&utm_campaign=hootsuite" target="_blank">Korean Mobile Advertising BUZZscape... </a><div class="date">2014.08.06</div></li>
								<li><a href="http://blog.naver.com/purplefrs/220078644274" target="_blank">4년차 이상의 경력의 모바일 마케팅 AE 채용</a> <div class="date">2014.08.05</div></li>
							</ul>
						</div>
					...
					<div class="s1_banner">
						...
						<div class="banner2">
							<a href="#"><img src="img/mmc_logo_sm.png" alt="mmc_logo"/></a>
							...
							<a href="#" class="newslatter_p"><img src="img/s1_newslatter.png" alt="newslatter"/></a>
						</div>
					</div>
						...
						<div id="st-accordion" class="st-accordion">
								...
								<ul id="itemContainer1">
									<?php
										...
										for ($i = $start; $i < $end; $i++) {
											echo '<li class="newsli"><a href="#">';
											// make sure that PHP doesn't try to show results that don't exist
											if ($i == $total_results) {
												break;
											}
										  
											echo '<div class="news_1">' . mysql_result($result, $i, 'news_no') . '</div>';
		...
		<section id="section-4">
			<div class="container">
				<div class="content">
					...
					<form action="mail.php" onsubmit="return fnCheck()" method="post" name="contactform" id="contactform" class="formular" enctype="multipart/form-data">
					<!-- <form name="form" method="post" enctype="multipart/form-data"> -->
					<input type="hidden" name="mailTo" value="hun8902@naver.com">
					<div class="project_rq_table">
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" class="pq_input" name="fromName" id="company_name">
								</td>
							</tr>
							<tr>
								<td style="width:195px; height:35px;"></td>
							...
							<tr>
								...
								<td>
									<input type="text" class="pq_input" name="mailFrom" id="e-mail">
								</td>
							</tr>
							<tr>
								<td style="width:195px; height:35px;"></td>
								...
								<td colspan="3">
									<input type="text" class="pq_input_l" name="title" id="title">
								</td>
							</tr>
							<tr>
