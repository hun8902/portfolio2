...
<title>Gosu Global Trading</title>
  ...
  <link rel="stylesheet" href="<?php echo $theme_select ?>/css/style.css" />
...
<script src="<?php echo $theme_select ?>/js/jquery.bpopup.min.js"></script>
  <link rel="stylesheet" media="screen" href="<?php echo $theme_select ?>/plugin/css/style.css">
...
<!-- scripts -->
<script src="<?php echo $theme_select ?>/plugin/particles.js"></script>
<script src="<?php echo $theme_select ?>/plugin/app.js"></script>
...
<div class="container">
	...
	<div id="scene3" class="scene3" style="display:none;">
		<div><img src="<?php echo $theme_select ?>/images/laptop.gif" class="notebook"></div>
		<span>Tas market profile</span>
	...
	<input name="landing" type="hidden" value="land002">
