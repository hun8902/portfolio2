...
<html lang="en">
 <head>
  <meta charset="UTF-8">
	...
	<meta property="og:url" content="http://m.purplefriends.co.kr/">
        <meta property="og:title" content="퍼플프렌즈">
        <meta property="og:type" content="website">
        <meta property="og:image" content="http://m.purplefriends.co.kr/img/purple_logo2.png">
  ...
  <div id="m_header">
   ...
   <div id="slider">
		...
		<div class="light" style="background-image: url(img/m_slider_3.png);">
			<q class="m_slider_more"><a class="fancybox"  href="img/work_popup_m16.png" target="_blank"><img src="img/m_slider_more.png"></a></q>
		</div>
		<div class="light" style="background-image: url(img/m_slider_4.png);">
			<q class="m_slider_more"><a class="fancybox"  href="img/work_popup_m17.png" target="_blank"><img src="img/m_slider_more.png"></a></q>
		</div>
	...
	<!--works -->
	<div id="works">
		<a href="http://yellomobile.com/" target="_blank" class="mmc_button">mmc</a>
...
<li><a href="http://www.mt.co.kr/view/mtview.php?type=1&no=2015061112432481054&outlink=1" target="_blank">'살려줘냥이'100만다운로드 돌파 </a> <div class="date">2015.06.11</div></li>
<li><a href="http://it.donga.com/21384/" target="_blank">모바일 트래킹기업 '튠'과 파트너십 체결</a> <div class="date">2015.06.03</div></li>
<li><a href="http://www.hankyung.com/news/app/newsview.php?aid=201504100011v" target="_blank">'한국예술원' 인재양성 위한 협약식 체결 </a> <div class="date">2015.04.10</div></li>
<li><a href="http://sports.khan.co.kr/news/sk_index.html?cat=view&art_id=201504031740193&sec_id=561101&pt=nv" target="_blank">'숨피닷컴'과 단독 매체 판매 MOU</a> <div class="date">2015.04.03</div></li>
	...
	<div id="request">
		...
		<div class="title_sub">등록하여주신 내용들은 퍼플프렌즈 고객리스트에 <br/>자동등록 됩니다.</div>
	...
	<div id="recruit">
		...
		<img src="ani/pplfs.gif" style="width:572px; height:322px; margin:20px 0"/>
	...
	<div id="footer">
		<div style="position:absolute; width:140px; height:27px; margin:160px 0 0 412px"><img src="/img/footer_logo.png"/></div>
		...
		<div class="footer3">
			...
			E-mail ; <a href="mailto:recruit@purplefriends.co.kr">request@purplefriends.co.kr</a>
