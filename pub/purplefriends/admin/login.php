...
<p><label for="username">Please Enter Username: </label><input type="text" size="20" name="username" id="username" value="id" /></p>
<p><label for="password">Please Enter Password: </label><input type="password" size="20" name="password" id="password" value="password" /></p>
