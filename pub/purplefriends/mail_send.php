...
if(!$use_html) $content = "체크박스: ".$cb1[0] ."&nbsp;".$cb1[1] . "&nbsp;".$cb1[2] ."&nbsp;".$cb1[3] ."&nbsp;".$cb1[4]."<br/>라디오박스: ".$cb2[0] ."&nbsp;".$cb2[1] . "&nbsp;".$cb2[2] ."&nbsp;".$cb2[3] ."&nbsp;".$cb2[4]."<br/>이름: ".$from_name ."<br/>위치: ".$position ."<br/>핸드폰: ".$phone_number ."<br/>내용". nl2br(htmlspecialchars($content));
...
else goUrl('메일이 정상적으로 발송되었습니다.', 'index.php');
?>