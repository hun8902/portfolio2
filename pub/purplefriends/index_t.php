...
<head>
	...
	<title>No.1 모바일마케팅그룹 퍼플프렌즈</title>
	<meta name="viewport" content="user-scalable=yes, initial-scale=0.3, maximum-scale=1.0, minimum-scale=0.1, width=device-width" />

	<meta property="og:url" content="http://www.purplefriends.co.kr/">
        <meta property="og:title" content="퍼플프렌즈">
        <meta property="og:type" content="website">
        <meta property="og:image" content="http://www.purplefriends.co.kr/img/purple_logo2.png">
        <meta property="og:description" content="No.1 모바일마케팅그룹 퍼플프렌즈" />
	...
	<script type="text/javascript">
	  $(document).ready(function() {
		...
		$("#cp_identity").click( function () {
			...
			$("#ta_identity").click( function () {
				$('#ta_identity').addClass("active");
				//$('#ta_identity1').addClass("active");
				$('#ta_organization').removeClass("active");
				$('#ta_client').removeClass("active");
				//$('#ta_organization1').removeClass("active");
				//$('#ta_client1').removeClass("active");
				//$('.clsBannerScreen').fadeIn("slow");
				//$('.clsBannerButton').fadeIn("slow");
				
				$('#taboola_content1').fadeIn("slow");
				$('#taboola_content2').hide();
				$('#taboola_content3').hide();
				

			});
			$("#ta_organization").click( function () {
				$('#ta_identity').removeClass("active");
				$('#ta_organization').addClass("active");
				$('#ta_client').removeClass("active");
				//$('#ta_client1').hide();
				//$('#ta_identity1').hide();
				//$('#ta_organization1').hide();
				//$('.clsBannerScreen').hide();
				//$('.clsBannerButton').hide();
				$('#taboola_content1').hide();
				$('#taboola_content2').fadeIn("slow");
				$('#taboola_content3').hide();

			});
			$("#ta_client").click( function () {
				$('#ta_identity').removeClass("active");
				$('#ta_organization').removeClass("active");
				$('#ta_client').addClass("active");
				//$('#ta_client1').hide();
				//$('#ta_organization1').hide();
				//$('#ta_identity1').hide();
				//$('.clsBannerScreen').hide();
...
<!--
$(function() {
	$("#image_list_3").jQBanner({nWidth:992,nHeight:535,nCount:2,isActType:"left",nOrderNo:1,isStartAct:"N",isStartDelay:"Y",nDelay:5000,isBtnType:"img"});
});
//$(function() {
//	$("#image_list_7").jQBanner({nWidth:992,nHeight:535,nCount:2,isActType:"left",nOrderNo:1,isStartAct:"N",isStartDelay:"Y",nDelay:5000,isBtnType:"img"});
//});
//-->
</script>
...
<script>(function() {
  ...
  _fbq.push(['addPixelId', '806100182769305']);
})();
window._fbq = window._fbq || [];
window._fbq.push(['track', 'PixelInitialized', {}]);
</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?id=806100182769305&amp;ev=PixelInitialized" /></noscript>
	...
	<nav id="navigation-menu">
		<div class="container">
			...
			<ul class="scroll_nav">
                ...
                <li class="nav_img7"><a href="#section-7">TABOOLA</a></li>
			...
			<div class="container">
				<div class="content">
					 <div id="slider">
						...
						<div class="light" style="background-image: url(img/1_n.png);">
                                                        <q class="main_banner_p"><a class="fancybox" href="img/works_17o.png" target="_blank"><img src="img/more.png"></a></q>
                                                </div>
						...
						<div class="light" style="background-image: url(img/3_n.png);">
							<q class="main_banner_p"><a class="fancybox"  href="img/works_18o.png" target="_blank"><img src="img/more.png"></a></q>
						</div>
...
<li><a href="https://www.facebook.com/mmcbymmc" target="_blank">퍼플프렌즈, MMC 2016 성공적 개최! </a> <div class="date">2015.10.27</div></li> 
<li><a href="http://platum.kr/archives/47924" target="_blank">퍼플프렌즈, 美TheTradeDesk와 파트너십 체결</a> <div class="date">2015.10.20</div></li>                                                       
<li><a href="http://www.hankyung.com/news/app/newsview.php?aid=201508289905v" target="_blank">퍼플프렌즈, 美 타불라와 전략적 파트너십 체결 </a> <div class="date">2015.08.27</div></li>
<li><a href="http://www.mt.co.kr/view/mtview.php?type=1&no=2015070915103441879&outlink=1" target="_blank">퍼플프렌즈 '대한민국우수기업대상' 수상 </a> <div class="date">2015.07.09</div></li>
<li><a href="http://it.donga.com/21384/" target="_blank">모바일광고 트래킹기업 '튠'과 파트너십 체결</a> <div class="date">2015.06.03</div></li>
					...
					<div class="s1_banner">
						<div class="banner1">
							<!-- <div style="float:left; margin-right:26px"><a href="http://yellomobile.com"><img src="img/yello_ym.png" alt="yello" /></a></div> -->
							<div style="float:left; margin-right:17px"><a href="https://www.taboola.com/ko/" target="_blank"><img src="img/taboola_logo.png" alt="taboola" /></a></div> 
							<div style="float:left; margin-right:17px"><a href="https://www.facebook.com/purplefriends" target="_blank"><img src="img/facebook.png" alt="facebook"></a></div>
			                                <div style="float:left; margin-right:17px;"><a href="http://blog.naver.com/purplefrs" target="_blank"><img src="img/blog.png" alt="blog"></a></div>
		...
		<section id="section-1">
			<div class="container">
				<div class="content" style="height:780px; overflow:hidden">
					...
					<div class="title_sub">전문적이고 보다 창의적인 발상의 통합디지털 마케팅 서비스를 제공하는 퍼플프렌즈의 크리에이티브</div>
					 <!-- item container -->
					  <ul id="itemContainer" >
						...
						<li><a class="fancybox-buttons" data-fancybox-group="button" href="img/works_17o.png"><img src="img/works_17.png" alt="" /></a></li>
						<li><a class="fancybox-buttons" data-fancybox-group="button" href="img/works_18o.png"><img src="img/works_18.png" alt="" /></a></li>
		...
		<section id="section-7">
			<div class="container">
				<div class="content">
					<div class="img_title"><img src="img/taboola_title.png" alt="taboola"/></div>
					<div class="title_sub">Taboola는 세계 최대 콘텐츠 디스커버리 플랫품 입니다. </div>
					<div class="taboola_tab">
						<span id="ta_identity" class="ta_identity">메뉴1</span>
						<span id="ta_organization" class="ta_organization">메뉴2</span>
						<span id="ta_client" class="ta_client">메뉴3</span>
					</div>


					
					<!--<div id="image_list_7">
					<ul class="clsBannerButton" id="label_7">
						<li><img src="img/fs.pager.png" oversrc="img/pager_over.png" outsrc="img/fs.pager.png" /></li>
						<li><img src="img/fs.pager.png" oversrc="img/pager_over.png" outsrc="img/fs.pager.png" /></li>
						<li><img src="img/fs.pager.png" oversrc="img/pager_over.png" outsrc="img/fs.pager.png" /></li>
					</ul> -->

					<div id="taboola_content1" class="taboola_content"><img src="img/taboola_1.jpg" alt="taboola_1"/></div>
                    <div id="taboola_content2" class="taboola_content"><img src="img/taboola_2.jpg" alt="taboola_2"/></div>
					<div id="taboola_content3" class="taboola_content"><img src="img/taboola_3.jpg" alt="taboola_3"/></div>
								...
								<ul id="itemContainer1">
									<?php
										...
										for ($i = $start; $i < $end; $i++) {
											...
											echo '<a href="#"><div class="news_1">' . mysql_result($result, $i, 'news_no') . '</div>';
											echo '<div class="news_2"><div class="news_title">' . mysql_result($result, $i, 'news_title') . '</div>';
											echo '<div class="news_text">' . mysql_result($result, $i, 'news_text') . '</div></div>';
											echo '<div class="news_arrow">updown</div>';
											echo '<div class="news_date">' . mysql_result($result, $i, 'news_date') . '</div>';
											echo '<div style="clear:both; border-bottom: 1px solid #c4c4c4;"></div>';
		...
		<section id="section-4">
			<div class="container">
				<div class="content">
					...
					<div class="title_sub">등록하여주신 내용들은 퍼플프렌즈 고객 리스트에 자동 등록 됩니다.</div>
						...
						<table>
							...
							<tr>
								...
								<td colspan="3">
									 ...
									 <div class="fileDiv">
											...
											<input class="realFile"  name="file"  onchange="javascript:document.getElementById('fakeFileTxt').value=this.value" type="file"/>
										</div>
							...
							<tr>
								...
								<td colspan="3">
									 <div class="fileDiv">
											<input class="buttonImg" type="button"/>
											<input class="realFile" name="file1"  onchange="javascript:document.getElementById('fakeFileTxt1').value=this.value" type="file"/>
										</div>
		...
		<section id="section-5">
			<div class="container">
				<div class="content">
					...
					<img src="m/ani/pplfs.gif" style="width:800px; height:451px; margin:40px 100px"/>
...
즐겁게 일할 수 있는 회사를 만들기 위해 <span class="color_purple">우리는 PPLFS라는 인재상</span>을 만들었습니다.<br/>
매사에 열정적이고 긍정적이며 타인을 사랑할 줄 알고 <br/>
모든 일을 즐겁게 받아들이는 현명한 사람을<br/>
퍼플프렌즈는 항상 찾고 있습니다.<br/>
		...
		<section id="section-6">
			<div class="container">
				<div class="content">
					<a href="purplefriends_2015.pdf" target="_blank"><div style="position:absolute; width:140px; height:27px; margin:516px 0 0 748px"></div></a>
	...
	<footer>
		<div class="container">
			<div style="position:absolute; width:140px; height:27px; margin:60px 0 0 432px"><img src="/img/footer_logo.png"/></div>
			<div class="footer1">2015 Copyright   <span class="purple_span">Purplefriends.</span> All Rights Reserved.</div>
			<div class="footer2">
	...
	<a href="https://plus.google.com/117929000027510425045" rel="publisher"></a>	
</body>
</html>
