...
function drpicon(a) {
    "style1" == a
        ...
        : ($(".pcoded-navbar").removeClassPrefix("drp-icon-"), $(".pcoded-navbar").addClass("drp-icon-" + a))
}
function menuitemicon(a) {
    "style1" == a
        ? $(".pcoded-navbar").removeClassPrefix("menu-item-icon-")
        : ($(".pcoded-navbar").removeClassPrefix("menu-item-icon-"), $(".pcoded-navbar").addClass("menu-item-icon-" + a))
}
$(document).ready(function () {
    ...
    $(".layout-type > a").on("click", function () {
        ...
        "dark" == a
            ? ($(".pcoded-navbar").removeClassPrefix("menu-"), $(".pcoded-navbar").addClass("navbar-dark"), $(".layout-css").attr("href", "../assets/css/layouts/dark.css"))
    ...
    $(".header-color > a").on("click", function () {
        ...
        "header-default" == a
            ...
            : ($(".pcoded-header").removeClassPrefix("header-"), $(".pcoded-header").addClass(a))
    }),
    $(".navbar-color > a").on("click", function () {
        ...
        "navbar-default" == a
            ...
            : ($(".pcoded-navbar").removeClassPrefix("navbar-"), $(".pcoded-navbar").addClass(a))
    }),
    $(".active-color > a").on("click", function () {
        ...
        "active-default" == a
            ...
            : ($(".pcoded-navbar").removeClassPrefix("active-"), $(".pcoded-navbar").addClass(a))
    }),
    ...
    $("#menu-fixed").change(function () {
        $(this).is(":checked")
            ...
            : ($(".pcoded-navbar").addClass("menupos-static"), setTimeout(function () {
                $(".navbar-content").css({overflow: "visible", height: "calc(100% - 70px)"})
            }, 400))
    }),
    $("#header-fixed").change(function () {
        $(this).is(":checked")
            ? ($(".pcoded-header").addClass("headerpos-fixed"), $(".pcoded-header").addClass("header-blue"), $(".header-color > a").removeClass("active"), $('.header-color > a[data-value="header-blue"]').addClass("active"))
    ...
    $("#box-layouts").change(function () {
        $(this).is(":checked")
            ? ($("body").addClass("container"), $("body").addClass("box-layout"))
            : ($("body").removeClass("container"), $("body").removeClass("box-layout"))
    }),
    ...
    $(".title-color > a").on("click", function () {
        ...
        "title-default" == a
            ...
            : ($(".pcoded-navbar").removeClassPrefix("title-"), $(".pcoded-navbar").addClass(a))
    }),
