...
(lib.정 = function() {
	this.spriteSheet = ss["prada_html5_720_atlas_"];
	this.gotoAndStop(0);
...
(lib.PRADA_1 = function() {
	this.initialize();

	// Layer 1
	this.instance = new lib.PRADA();
...
p.nominalBounds = new cjs.Rectangle(0,0,264,92);
...
p.nominalBounds = new cjs.Rectangle(0,0,274,93);
...
p.nominalBounds = new cjs.Rectangle(0,0,274,92);
...
// stage content:
(lib.prada_html5_720 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// p3
	this.instance = new lib.p3_1();
	this.instance.setTransform(712,64,1,1,0,0,0,132,46);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({x:332},9,cjs.Ease.get(1)).wait(116).to({y:222},5,cjs.Ease.get(-1)).wait(5));

	// p2
	this.instance_1 = new lib.p2_1();
	this.instance_1.setTransform(791,63.5,1,1,0,0,0,137,46.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({x:411},9,cjs.Ease.get(1)).wait(116).to({y:-86.5},5,cjs.Ease.get(-1)).wait(3));

	// p1
	this.instance_2 = new lib.p1_1();
	this.instance_2.setTransform(859,64,1,1,0,0,0,137,46);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(8).to({_off:false},0).to({x:479},9,cjs.Ease.get(1)).wait(116).to({y:224},5,cjs.Ease.get(-1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({_off:false},0).to({x:201,alpha:1},4,cjs.Ease.get(1)).wait(118).to({y:53.5},4,cjs.Ease.get(-1)).to({y:-49.5},3).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).to({x:157,alpha:1},4,cjs.Ease.get(1)).wait(119).to({y:53.5},4,cjs.Ease.get(-1)).to({y:-49.5},3).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({_off:false},0).to({x:110,alpha:1},4,cjs.Ease.get(1)).wait(120).to({y:53.5},4,cjs.Ease.get(-1)).to({y:-49.5},3).wait(6));
